...
var resizePizzas = function(size) {
 ...
 //**replace querySelectorAll to getElementsByClassName to prevent much processing
    ...
    var rpcl =document.getElementsByClassName("randomPizzaContainer").length;
...
var items = document.getElementsByClassName('mover');
  //var items = document.querySelectorAll('.mover');
    ...
    var scrollTop =  document.body.scrollTop;
     var scrollTop_Afterdiv=scrollTop / 1250;
...
for (var i = 0; i < 5; i++) {
    phase.push(Math.sin(scrollTop_Afterdiv + i) * 100);
}
  ...
  for (var i = 0; i < items.length; i++) {
   ...
   // var phase = Math.sin((scrollTop_Afterdiv) + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
    //**replace querySelector to getElementsByClassName to prevent much processing
    //**make document.querySelector("#movingPizzas1") out of the loop  to prevent making much processing
    //document.querySelector("#movingPizzas1").appendChild(elem);
    //** i use only 32 counter of pizza
     var mv1=  document.getElementById("movingPizzas1")
  for (var i = 0; i < 32; i++) {
